        ...
        methods: {
            ...
            initMap() {
                ...
                for (var i = 0; i < this.aptinfo.length; i++) {
                    aptinfo.push({
                        address: this.gugun_name + " " + this.aptinfo[i].법정동 + " " + this.aptinfo[i].지번,
                        aptname: this.aptinfo[i].아파트,
                    });
                }
                ...
                aptinfo.forEach(function (addr, index) {
                    geocoder.addressSearch(addr.address, function (result, status) {
                        if (status === kakao.maps.services.Status.OK) {
                            ...
                            var infowindow = new kakao.maps.InfoWindow({
                                content: addr.aptname, // 인포윈도우에 표시할 내용
                            });
