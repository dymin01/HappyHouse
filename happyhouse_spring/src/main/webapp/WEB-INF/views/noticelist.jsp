...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1 style="color:black">공지사항<span class="m_1">공지사항 페이지입니다.</span></h1>
		</div>
	</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <button type="button" class="btn btn-outline-success" onclick="location.href='${root}/notice/mvwrite'"> 공지사항 등록 </button>
	                ...
	                <div class="col-md-4 col-sm-6 col-xs-12">
	                    <div class="icon-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
							...
							<small class="readmore">
								<a href="${root }/notice/notice/${notice.articleno}">Read more</a>
							</small>
							</p>
							<div class="mt-3">
			                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="location.href='${root }/notice/mvmodify/${notice.articleno}'"> 수정 </button>
			                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="location.href='${root }/notice/delete/${notice.articleno}'"> 삭제 </button>
							</div>
